 ...
 */
class ImageProductsController extends \app\modules\admin\components\AdminController
{
    /**
     * @inheritDoc
     */
    ...
    {
    	$model = new ImageProducts(['scenario' => 'search']);
    ...
    {
        if (($model = ImageProducts::findOne(['id' => $id])) !== null) {
            return $model;
        }

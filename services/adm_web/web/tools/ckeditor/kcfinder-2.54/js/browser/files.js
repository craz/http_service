...
browser.returnFiles = function(files) {
    if (this.opener.callBackMultiple && files.length) {
        ...
        //console.log(this.opener.CKEditor.object.currentInstance);
        //console.log(this.opener.CKEditor.object.instances.Event_descr);

        //this.opener.CKEditor.object.instances.Event_descr.insertHTML("123");
        ...
        $.each(files, function(i, file) {
            ...
            window.opener.CKEDITOR.currentInstance.insertHtml('<img src="'+rfiles[i]+'" alt="" title=""/><br/>');
        });

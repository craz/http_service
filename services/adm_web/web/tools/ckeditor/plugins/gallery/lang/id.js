...
CKEDITOR.plugins.setLang( 'gallery', 'id', {
	...
	fakeObject : 'Gallery',
	imgTitle : 'Judul',
	imgDesc : 'Deskripsi Singkat',
	imgList : 'Gambar',
	imgAdd : 'Tambah Gambar',
	imgDelete : 'Hapus',
	imgEdit : 'Ubah',
	imgUp : "\u2191",
	imgDown : "\u2193",
    validModif : 'Simpan',
	previewMode : 'Preview',
	editGallery : 'Ubah Galeri',
	picturesList : "Daftar Gambar",
	insertGallery : 'Masukkan Galeri',
	...
	tr5 : 'Fade',
	// Opt Viewerjs
	viewerInterval : 'Interval',
	viewerButton : 'Show the button on the top-right',
	viewerMovable : 'Enable to move the image',
	viewerLoading : 'Show a loading spinner when load image or not',
});
